...
//// This project includes code derived from GoCV (https://github.com/hybridgroup/gocv),
// which is licensed under the Apache License 2.0.
//
// The original C wrapper files in src/ were adapted from GoCV and modified for
// use with Zig.
//
// Copyright (c) 2017-2024 The Hybrid Group
